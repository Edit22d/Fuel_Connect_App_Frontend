...
class StationDetailScreen4 extends StatelessWidget {
  const StationDetailScreen4({super.key});
          ...
          Stack(
            children: [
              SizedBox(
                ...
                child: Image.asset(
                  'assets/images/Rubis_station.png',
                  fit: BoxFit.cover,
                ),
              ),
              Container(
              ...
              // Station name + location bottom-left
              Positioned(
                bottom: 16,
                left: 16,
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text('Kyaliwajjala District, Obuasirand',
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Fuel Payment header
                  Text('FUEL PAYMENT', style: TextStyle(color: Colors.grey[500], fontSize: 10, letterSpacing: 1)),
                  const SizedBox(height: 10),

                  // Fuel rows with ORDER NOW
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text('INSTANT ORDER',
                            style: TextStyle(color: Colors.grey[500], fontSize: 10, letterSpacing: 1, fontWeight: FontWeight.w600)),
                        const SizedBox(height: 10),
                        Row(
                          children: [
                            Container(
                              ...
                              child: const Icon(Icons.local_gas_station, color: Color(0xFFD4A017), size: 22),
                            ),
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text('₦ 865.00/litre', style: TextStyle(color: Colors.grey[500], fontSize: 11)),
                              ],
                            ),
                          ],
                        ),
                        ...
                        Row(
                          ...
                          children: [
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('VOLUME', style: TextStyle(color: Colors.grey[500], fontSize: 9, letterSpacing: 0.5)),
                                const Text('45.50 Liters',
                                    style: TextStyle(color: Color(0xFFD4A017), fontSize: 16, fontWeight: FontWeight.w800)),
                              ],
                            ),
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.end,
                              children: [
                                Text('AMOUNT', style: TextStyle(color: Colors.grey[500], fontSize: 9, letterSpacing: 0.5)),
                                const Text('\$78.25',
                  ...
                  // Area FCs
                  Text('AREA FCs', style: TextStyle(color: Colors.grey[500], fontSize: 10, letterSpacing: 1)),
