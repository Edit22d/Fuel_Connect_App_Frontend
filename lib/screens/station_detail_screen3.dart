...
class StationDetailScreen3 extends StatelessWidget {
  const StationDetailScreen3({super.key});
              ...
              Positioned(
                ...
                child: Row(
                  children: [
                    ...
                    Text('Shell District', style: TextStyle(color: Colors.grey[400], fontSize: 10)),
                  ],
                ),
              ),
            ],
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Payment method row (Voucher + Change)
                  Container(
                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              child: const Center(
                                child: Icon(Icons.confirmation_number_outlined, color: Color(0xFF4CAF50), size: 14),
                              ),
                            ),
                            const SizedBox(width: 10),
                            Text('Voucher', style: TextStyle(color: Colors.grey[300], fontSize: 13, fontWeight: FontWeight.w500)),
                          ],
                        ),
                        TextButton(
                          onPressed: () {},
